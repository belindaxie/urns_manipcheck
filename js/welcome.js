...
welcome.section.start =
    ...
    '<li> The study then explains how to do the task in detail. You will need to pass short ' +
    '     tests to check that you understand how the study works.<br></li>' +
...
welcome.section.consent =
    ...
    '			<p>Any information that is obtained in connection with this study and that can be identified with you will remain confidential and will be disclosed only with your permission or except as required by law.  If you give us your permission by clicking the "I Agree" button, we plan to discuss/publish the results in academic journals and/or at conferences. In any publication, information will be provided in such a way that you cannot be identified.</p>' +
    ...
    '			<p><b>Inquiries</b></p>' +
    '			<p>If you have any questions or concerns following your participation, Belinda Xie (email: belinda.xie@unsw.edu.au) will be happy to address them. Complaints about the study may be directed to UNSW&#8217;s Research Ethics and Compliance Support, (phone +61 2 9385 4235 or +61 2 9385 4958, email. humanethics@unsw.edu.au).<p> ' +
